...
topics = {
    ...
    "policy_topics": {
        ...
        "Yield curve control": [
            "yct",
            "YCT",
            "yield caps or target",
            "capped",
            "yield curve control",
            "yield caps",
            "target interest rate",
            "cap rate",
            "capping longer term interest",
            "cap shorter-term",
        ],
        "Asset purchases": [
            "asset purchase",
    ...
    "quantitative_words": {
        "Consensus": [
            ...
            "almost all",
            "member judged",
            "participant all agreed",
            "participants generally",
        ],
        "Few": [
            "few participant",
            "one member",
            "a couple of participant",
            "one participant",
            "few other",
        ],
    },
...
in_deep_topics = {
    "asset_program": {
        ...
        "Pace": ["pace"],
        "Keep same size": [
            "rolling out at auction all principal",
            "roll over at auction all principal payments",
            "rolling over at auction all principal payment",
            "continue reinvesting all principal",
            "ending the reduction",
            "rolling over maturing treasury securities at auction",
            "existing policy of reinvesting principal payment",
        ],
        "Increase size": [
        ...
        "Taper amounts": [
            "taper",
            "tapering",
            "billion per month rather than",
            "reduce the pace of asset purchase",
            "net purchases cease",
        ],
        "Guidance": ["guidance"],
